    ...
    <footer className="bg-theme pt-16 pb-8 border-t border-theme/5 text-theme text-xs">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className={`border-t border-theme/5 pt-8 flex items-center justify-between gap-4 text-[10px] text-theme uppercase tracking-wider ${
          ...
          <p>Â© 2024 Khushi Enterprise Laboratory Aspected in Moderm Explorer. All Rights Reserved.</p>
          <div className="flex gap-2">
            <span className="w-8 h-8 rounded-full bg-theme/5 flex items-center justify-center hover:bg-theme/10 hover:text-theme transition-colors cursor-pointer">â˜…</span>
          </div>
        </div>
      </div>
    </footer>
