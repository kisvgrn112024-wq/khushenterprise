...
export default function HeroSection() {
  return (
    <div className="relative w-full bg-theme min-h-[600px] lg:h-[700px] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-20 flex flex-col lg:flex-row items-center justify-between gap-12 py-12">
        <div className="max-w-xl w-full lg:w-1/2">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-theme mb-6 leading-[1.1] tracking-tight">
              Precision for the <br />
              <span className="text-electric-blue">Modern Laboratory.</span>
            </h1>
            
            <p className="text-theme text-sm md:text-base mb-10 leading-relaxed font-light">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <Link href="/products">
                <button className="bg-electric-blue hover:bg-blue-600 text-theme px-8 py-3.5 rounded text-xs font-bold uppercase tracking-wider transition-colors">
                  Explore Products
                </button>
              </Link>
              <button className="bg-transparent text-theme px-8 py-3.5 rounded text-xs font-bold uppercase tracking-wider transition-colors border border-theme/20 hover:border-theme/50 hover:text-theme">
                 Download Catalogue
              </button>
            </div>
          </motion.div>
        ...
        <div className="w-full lg:w-1/2 flex justify-end">
          ...
          >
             ...
             <div className="absolute inset-0 rounded-2xl overflow-hidden border border-theme/10 shadow-2xl">
