                    ...
                    <div key={item.id} className="flex gap-4 p-4 glass-dark rounded-xl border border-theme/5 relative group">
                      ...
                      <div className="flex-1 flex flex-col">
                        ...
                        {item.moq && item.quantity >= item.moq && item.bulkPrice ? (
                           <div className="mb-3">
                             <div className="font-bold text-neon-cyan">â‚¹{item.bulkPrice.toLocaleString()} <span className="text-xs font-normal text-slate-400">/ea</span></div>
                           ...
                           <div className="font-bold text-neon-cyan mb-3">â‚¹{item.price.toLocaleString()} <span className="text-xs font-normal text-slate-400">/ea</span></div>
                        )}
            ...
            {cart.length > 0 && (
              <div className="p-6 border-t border-theme/10 bg-theme">
                <div className="flex items-center justify-between text-slate-300 mb-2">
                  <span>Subtotal</span>
                  <span className="text-theme font-medium">â‚¹{cartTotal.toLocaleString()}</span>
                </div>
