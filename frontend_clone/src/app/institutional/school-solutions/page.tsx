    ...
    <div className="flex flex-col min-h-full p-8 md:p-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
        <div className="max-w-2xl">
          <div className="text-[10px] font-mono text-theme uppercase tracking-widest mb-3 border border-theme/10 bg-theme/5 px-2 py-0.5 rounded w-fit">
            K-12 / SECONDARY LAB SUITES
          </div>
          <h1 className="text-4xl md:text-5xl font-black text-theme leading-[1.1] tracking-tight mb-4">
            School Laboratory Solutions
          </h1>
          <p className="text-theme text-sm leading-relaxed max-w-lg">
        ...
        <button className="bg-theme hover:bg-theme text-theme px-6 py-3.5 rounded font-bold text-sm uppercase tracking-wider transition-colors flex items-center justify-center gap-3 shrink-0 h-fit">
          <FileText size={16} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {/* Biology */}
        <div className="bg-theme border border-theme/10 rounded-xl overflow-hidden hover:border-theme/40 transition-colors flex flex-col group">
          <div className="aspect-[4/3] bg-theme relative overflow-hidden flex items-center justify-center border-b border-theme/5">
             ...
             <div className="absolute top-4 left-4 bg-theme/60 backdrop-blur-sm border border-theme/10 px-2 py-1 rounded text-[9px] font-mono text-[#e5a93b] font-bold uppercase flex items-center gap-1.5">
               <div className="w-1.5 h-1.5 bg-theme rounded-full"></div> IN STOCK
             </div>
          </div>
          
          <div className="p-6 flex-1 flex flex-col">
            <h3 className="text-lg font-bold text-theme mb-6">Biology Lab Infrastructure</h3>
            ...
            <Link href="/institutional/packages/biology" className="border border-theme/20 hover:border-theme text-theme font-bold text-[11px] uppercase tracking-wider py-3 rounded text-center transition-colors">
        ...
        <div className="bg-theme border border-theme/10 rounded-xl overflow-hidden hover:border-theme/40 transition-colors flex flex-col group">
          <div className="aspect-[4/3] bg-theme relative overflow-hidden flex items-center justify-center border-b border-theme/5">
             ...
             <div className="absolute inset-0 bg-gradient-to-t from-[#161616] via-transparent to-transparent opacity-90"></div>
             <div className="absolute top-4 left-4 bg-theme/60 backdrop-blur-sm border border-theme/10 px-2 py-1 rounded text-[9px] font-mono text-theme font-bold uppercase flex items-center gap-1.5">
               <div className="w-1.5 h-1.5 bg-theme rounded-full"></div> LIMITED STOCK
             </div>
          </div>
          
          <div className="p-6 flex-1 flex flex-col">
            <h3 className="text-lg font-bold text-theme mb-6">Chemistry Lab Infrastructure</h3>
            ...
            <Link href="/institutional/packages/chemistry" className="border border-theme/20 hover:border-theme text-theme font-bold text-[11px] uppercase tracking-wider py-3 rounded text-center transition-colors">
              Configure Suite Package
            </Link>
          </div>
        </div>
        ...
        <div className="bg-theme border border-theme/10 rounded-xl overflow-hidden hover:border-theme/40 transition-colors flex flex-col group">
          ...
          <div className="p-6 flex-1 flex flex-col">
            <h3 className="text-lg font-bold text-theme mb-6">Physics Lab Infrastructure</h3>
            ...
            <Link href="/institutional/packages/physics" className="border border-theme/20 hover:border-theme text-theme font-bold text-[11px] uppercase tracking-wider py-3 rounded text-center transition-colors">
              Configure Suite Package
            </Link>
          </div>
        </div>
