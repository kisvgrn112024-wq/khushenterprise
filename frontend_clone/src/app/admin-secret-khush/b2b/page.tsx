                      ...
                      <div key={prod.id} className="bg-theme border border-theme/30 p-5 rounded-lg space-y-3 hover:border-theme/20 transition-all">
                        ...
                        <div className="flex justify-between items-center pt-2 border-t border-theme/30">
                          <div>
                            ...
                            <div className="text-sm font-black text-theme">â‚¹{prod.price?.toLocaleString()}</div>
                          </div>
                          <div>
                            <div className="text-[9px] text-theme uppercase text-right">Bulk Sourcing</div>
                            <div className="text-xs font-bold text-[#e5a93b]">â‚¹{prod.bulkPrice?.toLocaleString() || "Quote req."}</div>
                          </div>
                        </div>
                      </div>
                    ))}
                        ...
                        <div key={prod.id} className="bg-theme border border-theme/30 p-5 rounded-lg space-y-3">
                          ...
                          <div className="flex justify-between items-center pt-2 border-t border-theme/30">
                            <div>
                              ...
                              <div className="text-sm font-bold text-[#e5a93b]">â‚¹{prod.price}</div>
                            </div>
                      ...
                      <div key={prod.id} className="bg-theme border border-theme/30 p-5 rounded-lg space-y-3">
                        ...
                        <div className="flex justify-between items-center pt-2 border-t border-theme/30">
                          <div>
                            ...
                            <div className="text-sm font-bold text-[#8bceff]">â‚¹{prod.price}</div>
                          </div>
            ...
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-theme border border-theme/30 p-5 rounded-lg">
                  ...
                  <div className="text-2xl font-black text-theme mt-1">â‚¹4,82,500.00</div>
                </div>
                <div className="bg-theme border border-theme/30 p-5 rounded-lg">
                    ...
                    {commercialTests.map(svc => (
                      <div key={svc.id} className="bg-theme border border-theme/30 p-5 rounded-lg flex justify-between items-center">
                        ...
                        <div className="text-right space-y-2">
                          ...
                          <div className="text-base font-black text-[#e5a93b]">â‚¹{svc.price.toLocaleString()}</div>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs leading-relaxed">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="text-sm font-black text-[#e5a93b] font-mono">â‚¹{selectedInquiry.value.toLocaleString()}</div>
                </div>
                <div>
