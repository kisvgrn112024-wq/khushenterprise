      ...
      <div className="glass border border-white/10 rounded-xl overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-3 min-h-[500px]">
          <div className="border-r border-white/10 bg-black/20">
             <div className="p-4 border-b border-white/10 bg-white/5 border-l-4 border-l-electric-blue cursor-pointer">
                <div className="flex justify-between mb-1">
                  <span className="font-bold text-white text-sm">Apex Labs</span>
                  <span className="text-[10px] text-slate-400">10 mins ago</span>
                </div>
                <p className="text-xs text-slate-400 truncate">Looking for bulk pricing on Microscopes...</p>
             </div>
             <div className="p-4 border-b border-white/10 cursor-pointer hover:bg-white/5">
                <div className="flex justify-between mb-1">
                  <span className="font-bold text-white text-sm">City High School</span>
          ...
          <div className="col-span-2 p-6 flex flex-col">
             <div className="flex justify-between items-start mb-6 pb-6 border-b border-white/10">
               <div>
                 <h2 className="text-lg font-bold text-white">RFQ: Bulk Pricing Microscopes</h2>
                 <p className="text-sm text-slate-400">From: apex.labs@example.com | Phone: +91 9876543210</p>
               </div>
               <button className="bg-electric-blue hover:bg-blue-600 text-white px-4 py-2 rounded-lg font-medium flex items-center gap-2 transition-colors text-sm">
