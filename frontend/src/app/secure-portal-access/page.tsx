...
export default function SecureAdminPortalLogin() {
  ...
  return (
    <>
      ...
      <div className="h-screen bg-theme flex items-center justify-center relative overflow-hidden font-sans">
        ...
        <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-theme/5 blur-[150px] rounded-full -z-10"></div>

        <div className="w-full max-w-md p-8 bg-theme/80 border border-theme/10 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.8)] backdrop-blur-md relative z-10 mx-4">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-black tracking-tight text-theme mb-1.5 uppercase">System Access</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-theme/40 border border-theme/10 rounded-lg py-2.5 px-4 text-theme text-xs outline-none focus:border-blue-500/60 focus:ring-1 focus:ring-blue-500/30 transition-all font-mono"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-theme/40 border border-theme/10 rounded-lg py-2.5 pl-4 pr-10 text-theme text-xs outline-none focus:border-blue-500/60 focus:ring-1 focus:ring-blue-500/30 transition-all font-mono"
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 disabled:from-blue-800 disabled:to-cyan-800 text-theme font-bold py-3 rounded-lg flex items-center justify-center gap-2 transition-all shadow-[0_4px_12px_rgba(59,130,246,0.2)] text-xs uppercase tracking-wider cursor-pointer"
            >
